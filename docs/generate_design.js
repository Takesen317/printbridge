...
const designDoc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      createParagraph("网络设备：宽带连接（可选，用于更新配置文件）"),
      ...
      createParagraph("Node.js：18.0.0 或更高"),
      ...
      new Table({
        width: { size: CONTENT_WIDTH, type: WidthType.DXA },
        columnWidths: [1500, 3000, 6406],
        rows: [
          new TableRow({ children: [
            createCell("编号", 1500, true),
            createCell("名称", 3000, true),
            createCell("模块功能描述", 6406, true)
          ]}),
          new TableRow({ children: [createCell("101", 1500), createCell("导入图像", 3000), createCell("用户导入RGB/CMYK图像文件", 6406)] }),
          new TableRow({ children: [createCell("102", 1500), createCell("选择ICC配置文件", 3000), createCell("选择源色彩配置文件和目标打印配置文件", 6406)] }),
          new TableRow({ children: [createCell("103", 1500), createCell("色彩分析", 3000), createCell("分析图像色彩范围与色域", 6406)] }),
          new TableRow({ children: [createCell("104", 1500), createCell("软打样预览", 3000), createCell("在屏幕上模拟印刷效果", 6406)] }),
          new TableRow({ children: [createCell("105", 1500), createCell("并排对比", 3000), createCell("数字显示与模拟印刷并排对比", 6406)] }),
          new TableRow({ children: [createCell("106", 1500), createCell("叠加对比", 3000), createCell("数字显示与模拟印刷叠加对比", 6406)] }),
          new TableRow({ children: [createCell("107", 1500), createCell("光源模拟", 3000), createCell("D50/D65/F光源色温效果", 6406)] }),
          new TableRow({ children: [createCell("108", 1500), createCell("纸张材质模拟", 3000), createCell("铜版纸/哑光纸/新闻纸效果", 6406)] }),
          new TableRow({ children: [createCell("109", 1500), createCell("观察距离模拟", 3000), createCell("不同观察距离的清晰度效果", 6406)] }),
          new TableRow({ children: [createCell("110", 1500), createCell("分辨率模拟", 3000), createCell("不同DPI的图像清晰度", 6406)] }),
          new TableRow({ children: [createCell("201", 1500), createCell("打印问题检测", 3000), createCell("检测图像分辨率、色彩空间等问题", 6406)] }),
          new TableRow({ children: [createCell("202", 1500), createCell("打印就绪向导", 3000), createCell("引导用户解决打印问题", 6406)] }),
          new TableRow({ children: [createCell("301", 1500), createCell("浏览案例库", 3000), createCell("浏览学习案例", 6406)] }),
          new TableRow({ children: [createCell("302", 1500), createCell("互动演示", 3000), createCell("观看色彩管理演示", 6406)] }),
          new TableRow({ children: [createCell("303", 1500), createCell("参与测验", 3000), createCell("测试色彩管理知识", 6406)] })
        ]
      }),
      ...
      new Table({
        ...
        rows: [
          new TableRow({ children: [
            createCell("编号", 1500, true),
            createCell("表名/结构名", 4000, true),
            createCell("表功能说明", 5406, true)
          ]}),
      ...
      new Paragraph({ children: [new TextRun({ text: "[图1 数据存储结构关系图 - 待插入]", italics: true, color: "999999" })], alignment: AlignmentType.CENTER, spacing: { before: 200, after: 200 } }),
      ...
      new Table({
        ...
        rows: [
          new TableRow({ children: [
            createCell("序号", 1200, true),
            createCell("字段名", 2500, true),
            createCell("数据类型", 2500, true),
            createCell("字段说明", 3706, true)
          ]}),
      ...
      new Paragraph({ children: [new TextRun({ text: "[图2 色彩实验室系统类图 - 待插入]", italics: true, color: "999999" })], alignment: AlignmentType.CENTER, spacing: { before: 200, after: 200 } }),

      createHeading("4.2 跨媒介预览系统设计", HeadingLevel.HEADING_2),
      createParagraph("跨媒介预览系统类图设计如图3所示。"),
      new Paragraph({ children: [new TextRun({ text: "[图3 跨媒介预览系统类图 - 待插入]", italics: true, color: "999999" })], alignment: AlignmentType.CENTER, spacing: { before: 200, after: 200 } }),

      createParagraph("跨媒介预览活动图设计如图4所示。"),
      new Paragraph({ children: [new TextRun({ text: "[图4 跨媒介预览活动图 - 待插入]", italics: true, color: "999999" })], alignment: AlignmentType.CENTER, spacing: { before: 200, after: 200 } }),

      createParagraph("跨媒介预览顺序图设计如图5所示。"),
      new Paragraph({ children: [new TextRun({ text: "[图5 跨媒介预览顺序图 - 待插入]", italics: true, color: "999999" })], alignment: AlignmentType.CENTER, spacing: { before: 200, after: 200 } }),

      createHeading("4.3 打印适配系统设计", HeadingLevel.HEADING_2),
      createParagraph("打印适配系统类图设计如图6所示。"),
      new Paragraph({ children: [new TextRun({ text: "[图6 打印适配系统类图 - 待插入]", italics: true, color: "999999" })], alignment: AlignmentType.CENTER, spacing: { before: 200, after: 200 } }),

      createHeading("4.4 知识中心系统设计", HeadingLevel.HEADING_2),
      createParagraph("知识中心系统类图设计如图7所示。"),
      new Paragraph({ children: [new TextRun({ text: "[图7 知识中心系统类图 - 待插入]", italics: true, color: "999999" })], alignment: AlignmentType.CENTER, spacing: { before: 200, after: 200 } }),
      ...
      new Table({
        ...
        rows: [
          new TableRow({ children: [
            createCell("子系统名称", 3500, true),
            createCell("游客", 2800, true),
            createCell("用户", 2806, true)
          ]}),
